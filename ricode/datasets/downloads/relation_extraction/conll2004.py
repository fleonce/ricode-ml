...
class CoNLL2004(TextDataset):
    ...
    data_files = {
        "train": (
            "conll04_train.json",
            "https://lavis.cs.hs-rm.de/storage/spert/public/datasets/conll04/conll04_train.json",
        ),
        "train+dev": (
            "conll04_train_dev.json",
            "https://lavis.cs.hs-rm.de/storage/spert/public/datasets/conll04/conll04_train_dev.json",
        ),
        "dev": (
            "conll04_dev.json",
            "https://lavis.cs.hs-rm.de/storage/spert/public/datasets/conll04/conll04_dev.json",
        ),
        "test": (
            "conll04_test.json",
            "https://lavis.cs.hs-rm.de/storage/spert/public/datasets/conll04/conll04_test.json",
        ),
        "types": (
            "conll04_types.json",
            "https://lavis.cs.hs-rm.de/storage/spert/public/datasets/conll04/conll04_types.json",
        ),
    }
